...
public class KCalendar extends ViewFlipper implements android.view.GestureDetector.OnGestureListener {
    private int COLOR_BG_WEEK_TITLE = Color.parseColor("#ffeeeeee"); // 星期标题背景颜色
    private int COLOR_TX_WEEK_TITLE = Color.parseColor("#ffcc3333"); // 星期标题文字颜色
    private int COLOR_TX_THIS_MONTH_DAY = Color.parseColor("#aa564b4b"); // 当前月日历数字颜色
    private int COLOR_TX_OTHER_MONTH_DAY = Color.parseColor("#ffcccccc"); // 其他月日历数字颜色
    private int COLOR_TX_THIS_DAY = Color.parseColor("#ff008000"); // 当天日历数字颜色
    private int COLOR_BG_THIS_DAY = Color.parseColor("#ffcccccc"); // 当天日历背景颜色
    private int COLOR_BG_CALENDAR = Color.parseColor("#ffeeeeee"); // 日历背景色
    ...
    private void init() {
        COLOR_BG_WEEK_TITLE = context.getResources().getColor(R.color.color_bg_week_title);
        COLOR_TX_WEEK_TITLE = context.getResources().getColor(R.color.color_tx_week_title);
        COLOR_TX_THIS_MONTH_DAY = context.getResources().getColor(R.color.color_tx_this_month_day);
        COLOR_TX_OTHER_MONTH_DAY = context.getResources().getColor(R.color.color_tx_other_month_day);
        COLOR_TX_THIS_DAY = context.getResources().getColor(R.color.color_tx_this_day);
        COLOR_BG_THIS_DAY = context.getResources().getColor(R.color.color_bg_this_day);
        COLOR_BG_CALENDAR = context.getResources().getColor(R.color.color_bg_calendar);
